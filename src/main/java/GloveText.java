...
public class GloveText {

        private static final Logger log = LoggerFactory.getLogger(GloveText.class);

        public GloveText(String test1, String test2){
            ...
            double simD = glove.similarity(test1, test2);
            log.info(test1+"/"+test2+" similarity: " + simD);

            Collection<String> words = glove.wordsNearest(test1, 10);
            log.info("Nearest words to '"+test1+"': " + words);

            System.exit(0);
        }
        public static void main(String[] args) throws Exception {
            new GloveText("Hot","Cold");
        }
    }
